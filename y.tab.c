...
#line 81 "parser.y" /* yacc.c:1646  */
    {
							...
							TAC* tac = tacGenerator((yyvsp[0].ast));
							fprintf(stderr, "\n\n\n");
							tac = tacInvert(tac);
							tacPrintInOrder(tac);
							hashPrint();
							astDeclaration((yyvsp[0].ast), fileout);
